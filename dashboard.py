...
from src.analytics.plotting import plot_daily_rides, plot_top_stations
...
def main():
    ...
    with right_col:
        ...
        daily_chart = plot_daily_rides(daily_rides)
    ...
    top_n_stations = st.slider(
        ...
        max_value=20,
        value=10,
        key="top_n_stations_slider",
    )

    # 2. Get the top stations data (DataFrame) using the filtered data
